...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 <= goal or score1 <= goal:
        ...
        if player == 0:
            ...
            leading = say(score0, score1)

        if player == 1:
            score1 += take_turn(strategy1(score1, score0), score0, dice)
            if is_swap(score0, score1) == True:
                score0, score1 = score1, score0
            say = leading(score0, score1)
...
def both(f, g):
    ...
    def new_function(score0, score1):
        def said(score0, score1):
            return both(f(score0, score1), g(score0, score1))
        return said(score0, score1)
    return new_function
    # END PROBLEM 6
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def so_high(score0, score1):
        nonlocal previous_high
        nonlocal previous_score
        if who == 0:
            computed_gain = score0 - previous_score
            if computed_gain > previous_high:
                previous_high = computed_gain
                if computed_gain == 1:
                    print(computed_gain, "point! That's the biggest gain yet for Player", who)
                else:
                    print(computed_gain, "points! That's the biggest gain yet for Player", who)
            return announce_highest(who, previous_high, score0)

        if who == 1:
            computed_gain = score1 - previous_score
            if computed_gain > previous_high:
                previous_high = computed_gain
                if computed_gain == 1:
                    print(computed_gain, "point! That's the biggest gain yet for Player", who)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while number_of_dice <= 10:
        experimental_total = make_averaged(roll_dice, num_samples)(number_of_dice, dice)

        current_average = experimental_total / num_samples
        if current_average > highest_average:
            highest_average = current_average
            best_dice = number_of_dice
        number_of_dice += 1
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    test_bacon = free_bacon(opponent_score)

    if test_bacon >= margin:
        return 0
    else:
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    possible_bacon = free_bacon(opponent_score)
    possible_score = possible_bacon + score
    possible_swap = is_swap(possible_score, opponent_score)

    if possible_swap == True and opponent_score > score:
        return 0
